...
const FAQ_DATA = [
    {
        questions: ["what is linguine ai", "what is this website"],
        answer: "Linguine AI helps you understand foreign restaurant menu cards by translating them into English and recommending the best food based on your preferences."
    },
    {
        questions: ["how does it work", "steps"],
        answer: "Just upload a photo of the menu card. I translate it into English, ask about your food preferences, and suggest the best dishes for you."
    },
    {
    ...
    },
    {
        ...
        answer: "Yes. Linguine AI is designed especially for travelers in foreign countries to bridge the language gap."
    },
    {
    ...
    },
    {
        ...
        answer: "What makes Linguine AI different is that it doesn't just translate text; it recommends food personalized to your unique taste and health preferences."
    }
];
...
export default function Chatbot() {
    ...
    const handleSend = (providedInput?: string) => {
        ...
        setTimeout(() => {
            let botAnswer = "I'm not sure about that. Try asking about how Linguine AI works, dietary filters, or our unique features!";
                    ...
                    >
                        ...
                        <div style={{ padding: '1.2rem', borderTop: '1px solid var(--glass-border)', display: 'flex', gap: '0.8rem' }}>
                            <input
                                ...
                                placeholder="Ask about Linguine AI..."
                                style={{
                                    flex: 1,
                                    background: 'rgba(255,255,255,0.05)',
                                    border: '1px solid var(--glass-border)',
